...
const POSTS = [
  {
    ...
    content: `
      <figure class="anim-figure" aria-hidden="false">
        <svg viewBox="0 0 900 260" role="img"
          ...
          <g stroke="#0D9488" stroke-opacity=".55" stroke-width="1.3">
            <line x1="60" y1="35" x2="450" y2="130"/>
            <line x1="60" y1="225" x2="450" y2="130"/>
            <line x1="150" y1="60" x2="450" y2="130"/>
            <line x1="150" y1="200" x2="450" y2="130"/>
            <line x1="840" y1="35" x2="450" y2="130"/>
            <line x1="840" y1="225" x2="450" y2="130"/>
            <line x1="750" y1="60" x2="450" y2="130"/>
            <line x1="750" y1="200" x2="450" y2="130"/>
          </g>

          <g fill="#0D9488">
            <circle cx="60" cy="35" r="6"/>
            <circle cx="60" cy="225" r="6"/>
            <circle cx="150" cy="60" r="5"/>
            <circle cx="150" cy="200" r="5"/>
          </g>

          <g fill="#EA580C">
            <circle cx="840" cy="35" r="9"/>
            <circle cx="840" cy="225" r="9"/>
            <circle cx="750" cy="60" r="7"/>
            <circle cx="750" cy="200" r="7"/>
          </g>
      ...
      <p>
        ...
        <strong>institutional reputation</strong>: faculty, research output,
        alumni, laboratories, industry relationships, selectivity,
        intellectual culture, and the ability to attract talented people.
      </p>
      ...
      <h2>AI can democratize capability without democratizing trust</h2>
      ...
      <p>
        Give both access to the same advanced AI systems: AI tutors,
        research agents, coding agents, literature-analysis systems and
        adaptive assessment.
      </p>
      ...
      <p>
        AI can give both institutions similar <em>analytical capability</em>.
      ...
      <h2>Will companies still come to universities for recruitment?</h2>
      ...
      <p>
        A university credential therefore becomes a signal: someone was
        admitted, completed a structured program, passed assessments and
        survived an institutional process.
      </p>
      ...
      <h2>The university may become a talent marketplace</h2>
      ...
      <h2>Will companies stop caring about university reputation?</h2>
      ...
      <p>
        ...
        <strong>prior probability</strong> about a candidate's preparation.
      ...
      <h2>AI may make recruitment more evidence-based</h2>
      ...
      <ul>
        <li>
          <strong>Degree:</strong> B.Tech / M.Tech / Ph.D.
        </li>
        <li>
      ...
      <h2>The Matthew effect could become stronger</h2>
      ...
      <p>
        ...
        It would be
        <strong>
          the person who knows what to ask the model to do, how to evaluate
          the result and what deserves to be pursued next.
        </strong>
      </p>
      ...
      <h2>The competitive advantage moves up the stack</h2>
      ...
      <ol>
        <li>
          <strong>Access to AI:</strong> increasingly universal.
        </li>
        <li>
          <strong>AI-enabled teaching:</strong> increasingly universal.
        </li>
        <li>
          <strong>AI-enabled research:</strong> increasingly common.
        </li>
        <li>
      ...
      <h2>Intellectual value may become more concentrated</h2>
      ...
      <h2>The university brand may change its meaning</h2>
      ...
      <h2>What happens to ordinary universities?</h2>
      ...
      <h2>Companies may increasingly recruit from projects, not just campuses</h2>
      ...
      <h2>The real question is not "Who has AI?"</h2>
      ...
      <h2>What should companies look for?</h2>
      ...
      <h2>The ultimate scarce resource may be judgment</h2>
      ...
      <h2>So, will university still matter?</h2>
...

  {
    ...
    content: `
      ...
      <p>
        ...
        A university can no longer sell information, because it has lost
        that market for good.
      </p>
